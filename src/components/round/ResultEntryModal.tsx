      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            {isSmash && match.player1Character && (
              <div className="text-xs text-red-300 mt-1">{getCharacterName(match.player1Character)}</div>
            )}
          </button>
          ...
          >
            ...
            {isSmash && match.player2Character && (
              <div className="text-xs text-red-300 mt-1">{getCharacterName(match.player2Character)}</div>
            )}
          </button>
        </div>
